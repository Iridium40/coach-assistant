...
export function Header({ onSettingsClick, onHomeClick, onAnnouncementsClick, onReportsClick, onInviteClick, activeTab, onTabChange }: HeaderProps) {
  ...
  const businessItems = [
    { label: "100's List", href: "/prospect-tracker", description: "Track your prospect pipeline" },
    { label: "Client List", href: "/client-tracker", description: "Touchpoints & milestones" },
    { label: "Coach List", href: "/coach-tracker", description: "Track team development & ranks" },
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            ...
            {!loading && user && isAdmin && (
              <Button
                ...
                className="hidden sm:flex items-center gap-2 border-[hsl(var(--optavia-green))] text-[hsl(var(--optavia-green))] hover:bg-[hsl(var(--optavia-green-light))] hover:border-[hsl(var(--optavia-green))] hover:text-[hsl(var(--optavia-green-dark))] transition-colors"
              >
