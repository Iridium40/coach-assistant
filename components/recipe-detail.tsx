          ...
          <Card className="p-4 sm:p-6">
            <ul className="space-y-2 mb-4">
              {recipe.ingredients.map((ingredient, index) => {
                ...
                return (
                  <li key={index} className="flex items-start gap-2 text-sm sm:text-base text-optavia-gray">
                    <input
                      type="checkbox"
                    ...
                    />
                    <span className={`break-words ${isChecked ? "line-through text-gray-400" : ""}`}>{ingredient}</span>
                  </li>
                )
              })}
            </ul>
