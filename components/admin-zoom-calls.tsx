...
export function AdminZoomCalls({ onClose }: { onClose?: () => void }) {
  ...
  const [startTime, setStartTime] = useState<string>("") // HH:MM for events with specific times
  const [endTime, setEndTime] = useState<string>("") // HH:MM for events with specific times
  ...
  const handleEdit = (call: ZoomCall, e?: React.MouseEvent) => {
    ...
    setStartTime((call as any).start_time || "")
    setEndTime((call as any).end_time || "")
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-4">
                  ...
                  {eventType === "event" ? (
                    ...
                    <>
                      ...
                      {/* Optional start/end times for events */}
          ...
          {zoomCalls.length > 0 && (
            <div className="flex gap-2">
              <Button
                ...
                className={typeFilter === "all" ? "bg-[hsl(var(--optavia-green))] hover:bg-[hsl(var(--optavia-green-dark))]" : "border-gray-300"}
              >
                All
              </Button>
              <Button
                ...
                className={typeFilter === "meeting" ? "bg-[hsl(var(--optavia-green))] hover:bg-[hsl(var(--optavia-green-dark))]" : "border-gray-300"}
              >
                <Video className="h-4 w-4 mr-1" />
                Meetings
              </Button>
              <Button
                ...
                className={typeFilter === "event" ? "bg-[hsl(var(--optavia-green))] hover:bg-[hsl(var(--optavia-green-dark))]" : "border-gray-300"}
              >
                <Calendar className="h-4 w-4 mr-1" />
                Events
              </Button>
