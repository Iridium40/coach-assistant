    ...
    <div className="relative h-[300px] overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 h-full flex flex-col justify-center text-white z-10">
        <div className="max-w-2xl">
          <h1 className="font-heading font-bold text-3xl md:text-4xl mb-2">Welcome Back, Coach!</h1>
          <Badge className="mb-4 bg-white/20 text-white border-white/30">
            {userData.isNewCoach ? "New Coach Journey" : "Full Access"}
          </Badge>
          <p className="text-lg mb-6">Continue your coaching journey and explore resources to support your clients</p>
