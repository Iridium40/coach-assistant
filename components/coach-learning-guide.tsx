...
const SCREENSHOTS: Record<string, Screenshot> = {
  "coach-list":  { img: `${SUPABASE_IMG}/coach-list.png`,  title: "🏋️ Coach List" },
  "add-coach":   { img: `${SUPABASE_IMG}/add-coach.png`,   title: "➕ Add Coach" },
  "rank-guide":  { img: `${SUPABASE_IMG}/rank-guide.png`,  title: "💡 Rank Guide & Focus" },
}
      ...
      <div style={{ position: "fixed", inset: 0, zIndex: 10000, background: "rgba(15,23,42,0.6)", backdropFilter: "blur(6px)", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px", overflowY: "auto" }}>
        <div style={{ maxWidth: "660px", width: "100%", background: "linear-gradient(170deg, #fff 0%, #f8fafb 100%)", borderRadius: "24px", overflow: "hidden", boxShadow: "0 8px 40px rgba(0,0,0,0.2)", animation: "coachSlideUp 0.3s ease", margin: "auto" }}>
          ...
          <div style={{ background: "linear-gradient(135deg, #2A9C95 0%, #37B6AE 50%, #5cbdab 100%)", padding: "36px 36px 32px", textAlign: "center", position: "relative", overflow: "hidden" }}>
            ...
            <span style={{ fontSize: "44px", display: "inline-block", marginBottom: "10px", position: "relative", filter: "drop-shadow(0 4px 12px rgba(0,0,0,0.15))" }}>🏋️</span>
          ...
          <div style={{ maxHeight: "calc(80vh - 200px)", overflowY: "auto", padding: "28px 32px 14px" }}>
            ...
            <div style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 800, fontSize: "11px", color: "#94a3b8", textTransform: "uppercase", letterSpacing: "1.5px", marginBottom: "10px", display: "flex", alignItems: "center", gap: "10px" }}>
              Coach Development Stages<span style={{ flex: 1, height: "1px", background: "linear-gradient(90deg, #e2e8f0, transparent)" }} />
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px", marginBottom: "18px" }}>
              {[
                ...
                { icon: "📅", text: "Schedule mentoring calls, 1-on-1s, and team meetings" },
                { icon: "⏰", text: "Remind — set follow-up reminders so no coach gets overlooked" },
                { icon: "🔍", text: "Filter by stage — All, New Coach, Building, Certified, Leader" },
            ...
            {/* How To */}
            <div style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 800, fontSize: "11px", color: "#94a3b8", textTransform: "uppercase", letterSpacing: "1.5px", marginBottom: "10px", display: "flex", alignItems: "center", gap: "10px" }}>
              Add Your First Coach<span style={{ flex: 1, height: "1px", background: "linear-gradient(90deg, #e2e8f0, transparent)" }} />
            </div>
