...
export function ExternalResourcesTab() {
  ...
  const resources: Resource[] = useMemo(() => [
    ...
    {
      id: "healthy-edge-community",
      title: "Healthy Edge Community",
      description: "Join the Healthy Edge community on Facebook to connect with fellow coaches, share wins, and grow together.",
