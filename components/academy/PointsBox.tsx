      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-4">
        {items.map((item, index) => (
          <div key={index} className="flex-1 flex flex-col items-center">
            {index > 0 && <div className="text-amber-400 font-bold text-lg mb-4 md:mb-0 md:mx-4">OR</div>}
            <div className="bg-slate-800/50 px-6 py-4 rounded-xl text-center w-full">
