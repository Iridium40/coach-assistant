...
export function getLogoUrl(): string {
  const baseUrl = process.env.NEXT_PUBLIC_APP_URL || "http://www.coachassistanthub.com"
...
export function getModuleCompletionEmailTemplate(options: {
  ...
  const appUrl = options.appUrl || process.env.NEXT_PUBLIC_APP_URL || "http://www.coachassistanthub.com"
