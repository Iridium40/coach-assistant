...
${phase.milestone ? `\n🎉 MILESTONE: ${phase.label} - Celebrate this achievement!` : ""}`,
      ...
      uid: `client-${selectedClient.id}-${Date.now()}@coachassistanthub.com`,
    }
  }
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              <Button
                className={`bg-[#f88221] border-[#f88221] text-white hover:bg-[#e07520] text-xs sm:text-sm${clients.length === 0 ? " animate-pulse" : ""}`}
